jQuery(document).ready(function () {
    ...
    if (
        jQuery(".iknow_tm_hero .main_menu, .iknow_tm_fixed_content .menubar")
            .length
    ) {
...
function iknow_tm_contact_form() {
    ...
    jQuery(".contact_form #send_message")
        ...
        .on("click", function () {
            ...
            var success = jQuery(".contact_form .returnmessage").data(
                "success"
            );
    ...
    if (element.length > 0) {
        element.each(function () {
            ...
            e.circleProgress({
                ...
                function (event, progress, stepValue) {
                    e.find("h3").text(
                        parseInt(stepValue.toFixed(2) * 100) + "%"
                    );
                }
            );
            setTimeout(function () {
...
function iknow_tm_extra_menu() {
    ...
    button.on("click", function () {
        ...
        $("html, body").animate({ scrollTop: top - marginBottom }, speed);
...
function iknow_tm_menubar() {
    "use strict";
    var li = jQuery(
        ".iknow_tm_fixed_content .menubar ul li, .transition_link a"
    );
    ...
    button.on("click", function () {
        ...
        if (!parent.hasClass("active")) {
            ...
            $(href).addClass("active");
            $(".mainbar").animate({ scrollTop: 0 }, 300);
            iknow_tm_owl_carousel();
        }
    });
}
function iknow_tm_page_transition() {
    ...
    button.on("click", function () {
        ...
        if (element.parent().hasClass("iknow_tm_button")) {
            jQuery('.menu.transition_link a[href="' + href + '"]').trigger(
                "click"
            );
            hashtag2();
            return false;
...
function iknow_tm_menu_width_new() {
    ...
    jQuery(".iknow_tm_mainpart_new_2 .main_menu ul li.current").each(
        function () {
            var element = jQuery(this);
            var elWidth = element.outerWidth();
            var textWidth = element.find("span").outerWidth();
...
function iknow_tm_scrollable() {
    ...
    if (WW <= 1400) {
        scrollable.each(function () {
            var element = jQuery(this);
            element
                .css({ height: H - topbar - image - footerHeight })
                .niceScroll({
                    touchbehavior: false,
                    cursorwidth: 0,
                    autohidemode: true,
    ...
    scrollable.each(function () {
        var element = jQuery(this);
        element
            .css({ height: H - topbar - image - footerHeight - 90 })
            .niceScroll({
                touchbehavior: false,
                cursorwidth: 0,
                autohidemode: true,
